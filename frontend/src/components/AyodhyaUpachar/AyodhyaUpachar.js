...
import './AyodhyaUpachar.css'; // Importing the CSS file for styling
...
const AyodhyaUpachar = () => {
  const { addToCart, getTotalCartItems } = useStore();

  return (
    <div className="AyodhyaUpachar-page">
      <header className="AyodhyaUpachar-header">
        <h1 className="AyodhyaUpachar-title">Welcome to AyodhyaUpachar</h1>

...
import './VidyarthiBhavan.css'; // Importing the CSS file for styling
import { assets } from '../../assets/assets'; // Assuming assets contains images for the page
import { useStore } from '../../Context/StoreContext';

// Sample menu items data
const menuItems = [
    { id: 1, name: 'Masala Dose', description: 'Served With Chutney & Sambar', price: 85, image: assets.MasalaDose },
    { id: 2, name: 'Plain Dose', description: 'Served With Chutney & Sagu', price: 80, image: assets.PlainDose },
    { id: 3, name: 'Rava Vada', description: 'Served With Chutney & Sagu', price: 44, image: assets.RavaVada },
    ...
    { id: 13, name: 'Chow Chow Bath', description: 'Khara Bath & Kesari Bath Served With Chutney', price: 130, image: assets.ChowChowBath},
...
const VidyarthiBhavan = () => {
  const { addToCart, getTotalCartItems } = useStore();

  return (
    <div className="VidyarthiBhavan-page">
      <header className="VidyarthiBhavan-header">
        <h1 className="VidyarthiBhavan-title">Welcome to VidyarthiBhavan</h1>
...
export default VidyarthiBhavan;

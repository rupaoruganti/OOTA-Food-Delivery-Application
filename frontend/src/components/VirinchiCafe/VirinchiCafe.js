...
import './VirinchiCafe.css'; // Importing the CSS file for styling
...
const VirinchiCafe = () => {
  ...
  return (
    <div className="VirinchiCafe-page">
      <header className="VirinchiCafe-header">
        <h1 className="VirinchiCafe-title">Welcome to VirinchiCafe</h1>

...
import './CafeAmudham.css'; // Importing the CSS file for styling
...
const CafeAmudham = () => {
  ...
  return (
    <div className="CafeAmudham-page">
      <header className="CafeAmudham-header">
        <h1 className="CafeAmudham-title">Welcome to CafeAmudham</h1>

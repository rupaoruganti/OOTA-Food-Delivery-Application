...
import './PuliyogarePoint.css'; // Importing the CSS file for styling
...
const PuliyogarePoint = () => {
  const { addToCart, getTotalCartItems } = useStore();

  return (
    <div className="PuliyogarePoint-page">
      <header className="PuliyogarePoint-header">
        <h1 className="PuliyogarePoint-title">Welcome to PuliyogarePoint</h1>
...
export default PuliyogarePoint;

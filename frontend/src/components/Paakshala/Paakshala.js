...
const Paakshala = () => {
  ...
  return (
    <div className="Paakshala-page">
      <header className="Paakshala-header">
        <h1 className="Paakshala-title">Welcome to Paakshala</h1>

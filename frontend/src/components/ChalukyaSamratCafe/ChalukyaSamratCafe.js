...
import './ChalukyaSamratCafe.css'; // Importing the CSS file for styling
...
const menuItems = [
    ...
    { id: 3, name: 'Dahi Vada', description: 'Serves 1', price: 75, image: assets.DahiVada },
    ...
    { id: 12, name: 'Sweet Lassi', description: 'A traditional, creamy sweet lassi made with yogurt, lightly flavored with sugar and a hint of cardamom.', price: 140, image: assets.Lassi },
...
const ChalukyaSamratCafe = () => {
  ...
  return (
    <div className="ChalukyaSamrat-page">
      <header className="ChalukyaSamrat-header">
        <h1 className="ChalukyaSamrat-title">Welcome to ChalukyaSamrat</h1>
...
export default ChalukyaSamratCafe;

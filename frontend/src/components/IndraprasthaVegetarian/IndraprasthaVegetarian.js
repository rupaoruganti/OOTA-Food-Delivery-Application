...
import './IndraprasthaVegetarian.css'; // Importing the CSS file for styling
...
const IndraprasthaVegetarian = () => {
  const { addToCart, getTotalCartItems } = useStore();

  return (
    <div className="IndraprasthaVegetarian-page">
      <header className="IndraprasthaVegetarian-header">
        <h1 className="IndraprasthaVegetarian-title">Welcome to IndraprasthaVegetarian</h1>
...
export default IndraprasthaVegetarian;

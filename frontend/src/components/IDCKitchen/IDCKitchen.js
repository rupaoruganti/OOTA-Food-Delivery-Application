...
import './IDCKitchen.css'; // Importing the CSS file for styling
import { assets } from '../../assets/assets'; // Assuming assets contains images for the page
import { useStore } from '../../Context/StoreContext';

// Sample menu items data
const menuItems = [
    { id: 1, name: 'Curd Rice', description: 'Serves 1', price: 95, image: assets.CurdRice },
...
const IDCKitchen = () => {
  ...
  return (
    <div className="IDCKitchen-page">
      <header className="IDCKitchen-header">
        <h1 className="IDCKitchen-title">Welcome to IDCKitchen</h1>

...
import './TheVegandVeg.css'; // Importing the CSS file for styling
...
const TheVegandVeg = () => {
  ...
  return (
    <div className="TheVegandVeg-page">
      <header className="TheVegandVeg-header">
        <h1 className="TheVegandVeg-title">Welcome to TheVegandVeg</h1>
